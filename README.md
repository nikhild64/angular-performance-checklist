...
- [Bazel](https://bazel.build/) - Bazel and fast and scalable build tool, it only builds what is necessary. Refer [Angular Example] (https://github.com/bazelbuild/rules_nodejs/tree/master/examples/angular) here 
